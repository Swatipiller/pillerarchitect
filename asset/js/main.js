...
(function ($) {
    ...
    var imJs = {
        ...
        swiperActivation: function (){
          ...
          $(document).ready(function() {
            var swiper = new Swiper(".pls_banner", {
              slidesPerView: 1,
              spaceBetween: 0,
              slidesPerGroup: 1,
              loop: true,
        ...
        popupMobileMenu: function (e) {
          ...
          $('.close-menu').on('click', function (e) {
              ...
              $('.popup-mobile-menu .mainmenu .has-droupdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').siblings('.submenu, .pls-megamenu').removeClass('active').slideUp('400');
          ...
          $('.body-mobile .mainmenu .has-droupdown > a, .body-mobile .mainmenu .with-megamenu > a').on('click', function (e) {
              e.preventDefault();
              $(this).siblings('.submenu, .pls-megamenu').toggleClass('active');
              $(this).toggleClass('open')
          })
          // nav menu end

          $('.popup-mobile-menu').on('click', function (e) {
              e.target === this && $('.popup-mobile-menu').removeClass('active') && $('.popup-mobile-menu .mainmenu .has-droupdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').siblings('.submenu, .pls-megamenu').removeClass('active').slideUp('400') && $('.popup-mobile-menu .mainmenu .has-droupdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').removeClass('open');
          });
